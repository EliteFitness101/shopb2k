...
export const Route = createFileRoute("/blog/$slug")({
  ...
  head: ({ loaderData, params }) => {
    ...
    const url = `https://resofit.fit/blog/${params.slug}`;
    return {
      meta: [
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-6 py-20">
        <Link to="/blog" className="text-xs uppercase tracking-widest text-muted-foreground hover:text-gold">← Journal</Link>
        ...
        <p className="mt-4 text-sm text-muted-foreground">{new Date(a.publishedAt).toLocaleDateString(undefined, { year: "numeric", month: "long", day: "numeric" })}{" · "}{a.readingMinutes} min read</p>
