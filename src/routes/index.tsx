      ...
      <section className="border-t border-border/60 bg-card/20 py-20">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-10 grid gap-px bg-border/60 md:grid-cols-3">
            {[
              { t: "Longevity seekers", d: "Healthy ageing, energy and biomarker-backed protocols." },
              { t: "Strength builders", d: "Mobility, recovery and progressive strength — coached." },
              { t: "Body-confidence journeys", d: "Sustainable nutrition and habit systems that stick." },
            ].map((x) => (
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <ol className="mt-10 grid gap-px bg-border/60 md:grid-cols-3">
            {[
              ...
              { n: "02", t: "Personalize", d: "We match programs, nutrition and equipment to you." },
