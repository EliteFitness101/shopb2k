    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="border-t border-border/60 bg-card/20 py-20">
        <div className="mx-auto max-w-7xl px-6">
          <p className="mb-3 text-xs uppercase tracking-[0.3em] text-gold">Who We Help</p>
          <h2 className="font-display text-4xl md:text-5xl">Built for every wellness path.</h2>
          <div className="mt-10 grid gap-px bg-border/60 md:grid-cols-3">
            {[
              {
                t: "Longevity seekers",
                d: "Healthy ageing, energy and biomarker-backed protocols.",
              },
              {
                t: "Strength builders",
                d: "Mobility, recovery and progressive strength — coached.",
              },
              {
                t: "Body-confidence journeys",
                d: "Sustainable nutrition and habit systems that stick.",
              },
            ].map((x) => (
              <div key={x.t} className="bg-background p-6">
                <div className="h-2 w-10 bg-gold/70" />
      ...
      <section className="border-t border-border/60 py-20">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <h2 className="font-display text-4xl md:text-5xl">Three steps to your plan.</h2>
          <ol className="mt-10 grid gap-px bg-border/60 md:grid-cols-3">
            {[
              { n: "01", t: "Assess", d: "60-second ChatB2K™ wellness assessment." },
              {
                n: "02",
                t: "Personalize",
                d: "We match programs, nutrition and equipment to you.",
              },
              { n: "03", t: "Live it", d: "Coaching, guides and community keep you consistent." },
            ].map((s) => (
      ...
      <section className="border-t border-border/60 bg-card/30 py-24">
        <div className="mx-auto max-w-5xl px-6 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-sm text-muted-foreground">
            Verified transformations from the ResoFit community. New stories drop weekly inside the
            Reset.
          </p>
