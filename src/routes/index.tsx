...
async function fetchFeaturedProducts(): Promise<ShopifyProduct[]> {
  for (const q of ["tag:featured", "tag:best-seller", ""]) {
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto grid min-h-[88vh] max-w-7xl items-center px-6 py-24">
          <div className="max-w-2xl">
            ...
            <p className="mt-6 text-[11px] uppercase tracking-[0.25em] text-muted-foreground">Take My Wellness Assessment · 60 seconds · No spam</p>
          </div>
        </div>
      </section>
      <TrustBar />
