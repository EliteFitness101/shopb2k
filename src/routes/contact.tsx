...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Talk to the ResoFit team — WhatsApp CoachB2K™ or email support." },
      ...
      { property: "og:url", content: "https://resofit.fit/contact" },
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-4xl px-6 py-20">
        ...
        <p className="mt-6 max-w-xl text-muted-foreground">The fastest way to reach us is WhatsApp. CoachB2K™ replies personally.</p>
