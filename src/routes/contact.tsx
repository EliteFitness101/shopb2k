...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Talk to the ResoFit team — WhatsApp CoachB2K™, email support or visit our Lagos workshop." },
      ...
      <main className="mx-auto max-w-4xl px-6 py-20">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          ...
          >
            ...
            <p className="mt-2 text-sm text-muted-foreground">Chat with CoachB2K™ · +234 813 225 5842</p>
          </a>
