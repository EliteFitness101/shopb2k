...
export const KNOWLEDGE_CATEGORIES: KnowledgeCategory[] = [
  {
    slug: "nutrition",
    title: "Nutrition",
    tagline: "Whole-food fuel for the way you actually eat.",
  },
  {
    slug: "healthy-living",
    title: "Healthy Living",
    tagline: "Sustainable habits for modern life.",
  },
  {
    slug: "healthy-ageing",
    title: "Healthy Ageing",
    tagline: "Build the next 40 years on purpose.",
  },
  ...
  { slug: "recipes", title: "Recipes", tagline: "Real meals for African kitchens." },
  {
    ...
    tagline: "Choose gear that outlives trends.",
  },
];
