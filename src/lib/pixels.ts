...
export function pixelPageView(path?: string) { if (typeof window === "undefined") return; try { window.fbq?.("track", "PageView"); window.ttq?.page(); if (GA4_ID) window.gtag?.("event", "page_view", { page_path: path ?? window.location.pathname }); } catch { void 0; } }
